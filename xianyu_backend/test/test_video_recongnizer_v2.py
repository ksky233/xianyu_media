...
async def test_single_baseinfo_workflow():
    ...
    try:
        print("\n1. 创建视频识别器（仅基础信息）...")
        recognizer = VideoRecongnizerV2(workflow_type="baseinfo")
        print(f"✅ 视频识别器创建成功")
...
async def test_single_hotinfo_workflow():
    ...
    try:
        print("\n1. 创建视频识别器（仅热度信息）...")
        recognizer = VideoRecongnizerV2(workflow_type="hotinfo")
        print(f"✅ 视频识别器创建成功")
