...
from app.shared.prompt import INSTRUCTION_VIDEO_BASEINFO_V2, INSTRUCTION_VIDEO_HOTINFO_FORMAT, INSTRUCTION_VIDEO_HOTINFO_GET, INSTRUCTION_VIDEO_SEARCHINFO_FORMAT, INSTRUCTION_VIDEO_SEARCHINFO_GET
